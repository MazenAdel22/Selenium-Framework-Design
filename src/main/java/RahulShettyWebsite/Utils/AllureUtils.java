package RahulShettyWebsite.Utils;
    ...
    public static void setAllureEnvironment() {
        allureEnvironmentWriter(
                ImmutableMap.<String, String>builder()
                        ...
                        .put("JDK", "21.0.1")
                        .put("URL", "https://rahulshettyacademy.com/client/#/auth/login")
                        .build(), "D://Testing//Projects//Automation//Selenium//SeleniumFrameworkDesign//test-outputs/allure-results/");
    }
